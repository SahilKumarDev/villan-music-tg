...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("VillanMusic/assets/font2.ttf", 30)
    font = ImageFont.truetype("VillanMusic/assets/font.ttf", 30)
    title_font = ImageFont.truetype("VillanMusic/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("VillanMusic/assets/play_icons.png")
